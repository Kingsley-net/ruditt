...
export default function ProgramCard({ title, description }) {
  return (
    <div className="border border-gray-200 p-8">
      ...
      <Editable tag="a" href="#" initialContent='Learn More <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" />' className="flex items-center font-semibold group" />
    </div>
  )
}
